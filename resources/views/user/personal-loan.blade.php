...
@section('content')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">DIGITAL PERSONAL LOAN APPLICATION</h4>
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">DIGITAL PERSONAL LOAN APPLICATION</li>
            </ul>
        </div>
                ...
                <div class="card card-round h-100">
                    <div class="card-body">
                        <form action="{{ route('user.apply.personal.loan.store') }}" method="POST">
                            @csrf
                            <input type="hidden" value="personal" name="loan_type">
                            <div class="row">
