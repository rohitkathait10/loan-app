    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">VIEW ADVERTISEMENT</li>
            </ul>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header row">
                        <h4 class="card-title col-md-6">View Advertisement</h4>
                        ...
                        <form action="javascript:void(0)">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control"
                                    value="{{ old('title', $ad->title) }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="content">Broadcast Message (Marquee Text)</label>
                                <textarea name="content" class="form-control" rows="8"  readonly>{{ old('content', $ad->content ?? '') }}</textarea>
                            </div>
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox" name="content_status" class="form-check-input" id="showContent"
                                    value="1" {{ old('content_status', $ad->content_status) ? 'checked' : '' }} disabled>
                            ...
                            <div class="form-group form-check">
                                <input type="checkbox" name="image_status" class="form-check-input" id="showImage"
                                    value="1" {{ old('image_status', $ad->image_status) ? 'checked' : '' }} disabled>
